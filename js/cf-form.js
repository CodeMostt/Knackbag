...
! function(t) {
    var e = function() {
        ...
        return t.parseTag = function(t) {
            ...
            for (var n in t) "tag" !== n && "children" !== n && e.setAttribute(n, t[n]);
            return e
        ...
        return __extends(n, e), Object.defineProperty(n.prototype, "type", {
            ...
            get: function() {
                ...
                if (n && !this.partOfSeveralChoices) {
                    e = (n ? '<img src="' + this.referenceTag.domElement.getAttribute("cf-image") + '"/>' : "") + t.Helpers.getInnerTextOfElement(this.el)
...
! function(t) {
    ...
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "active", {
            ...
            var e = this;
            clearTimeout(this.animateInFromReponseTimer), t.detail.currentResponse.isRobotResponse || (this.animateInFromReponseTimer = setTimeout(function() {
                e.animateElementsIn()
            ...
            this.list.offsetHeight, requestAnimationFrame(function() {
                t.ConversationalForm.illustrateFlow(e, "dispatch", t.ControlElementsEvents.CHANGED), e.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementsEvents.CHANGED))
            })
            ...
            if (i.length > 1) {
                ...
                this.filterListNumberOfVisible != o.length && this.animateElementsIn(), this.filterListNumberOfVisible = o.length, "" != e && this.filterListNumberOfVisible > 0 && (o[0].highlight = !0)
            }
            ...
            this.infoElement.classList.remove("show"), this.el.classList.remove("one-row"), this.el.classList.remove("two-row")
            ...
            this.filterListNumberOfVisible = r ? this.elements[0].elements.length : e.length, new Promise(function(t, e) {
                ...
                n.onListChanged(), t.ConversationalForm.illustrateFlow(n, "dispatch", t.UserInputEvents.CONTROL_ELEMENTS_ADDED, i), n.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.CONTROL_ELEMENTS_ADDED, {
                    detail: i
                }))
            })
            ...
            if (i && i.length > 0) {
                for (var o = [], s = [], r = !1, a = 0; a < i.length; a++) {
                    var l = i[a];
                    l.visible && (l.calcPosition(), this.listWidth += l.positionVector.width, o.push(l.positionVector.x + l.positionVector.width), s.push(l)), l.hasImage() && (r = !0)
                }
                var c = this.el.offsetWidth,
                    u = this.listWidth > c,
                    l = c < 992;
                if (l) {
                u && !r ? (this.el.classList.add("two-row"), this.listWidth = this.listWidth + 10, this.list.style.width = this.listWidth + "px") : this.el.classList.add("one-row");
                }
                else {
                u && !r ? (this.el.classList.add("two-row"), this.listWidth = Math.max(c, Math.round(o[Math.floor(o.length / 2)] + 50)), this.list.style.width = this.listWidth + "px") : this.el.classList.add("one-row");
                ...
                for (var h = i.slice(), p = h.sort(function(t, e) {
...
! function(t) {
    var e = function() {
        function e(t) {
            ...
            }, e.instance = this, t && t.data && (this.data = this.validateAndSetNewData(t.data, this.data)), t.userImage && (this.data["user-image"] = t.userImage), t.robotImage && (this.robotData["robot-image"] = t.robotImage), t && t.robotData && (this.robotData = this.validateAndSetNewData(t.robotData, this.robotData))
        }
...
! function(cf) {
    ...
    var Tag = function() {
        ...
        return Object.defineProperty(Tag.prototype, "type", {
            ...
            get: function() {
                return !this.checkConditionalAndIsValid() || void 0 != this.domElement.getAttribute("disabled") && null != this.domElement.getAttribute("disabled")
            },
            enumerable: !0,
            configurable: !0
            ...
            if (Tag.isTagValid(t)) {
                ...
                return "input" == t.tagName.toLowerCase() ? e = new cf.InputTag({
                    ...
                    domElement: t
                }) : "cf-robot-message" == t.tagName.toLowerCase() && (e = new cf.CfRobotMessageTag({
                    domElement: t
                })), e
            }
            return null
                ...
                for (var e in t)
                    if (t.hasOwnProperty(e)) {
                        ...
                        if (n && n.name && -1 !== n.name.indexOf("cf-conditional")) {
                            for (var i = [], o = -1 !== n.value.indexOf("||") ? n.value.split("||") : n.value.split("&&"), s = 0; s < o.length; s++) {
                                var r = o[s];
                                try {
                                    i.push(new RegExp(r))
                                } catch (t) {}
            ...
            if (!this.questions) {
                if (this.domElement.getAttribute("cf-questions")) this.questions = cf.Helpers.getValuesOfBars(this.domElement.getAttribute("cf-questions")), this.domElement.getAttribute("cf-input-placeholder") && (this._inputPlaceholder = this.domElement.getAttribute("cf-input-placeholder"));
                else if (this.domElement.parentNode && this.domElement.parentNode.getAttribute("cf-questions")) {
                    var t = this.domElement.parentNode;
                    this.questions = cf.Helpers.getValuesOfBars(t.getAttribute("cf-questions")), t.getAttribute("cf-input-placeholder") && (this._inputPlaceholder = t.getAttribute("cf-input-placeholder"))
                } else {
            ...
            if (this.domElement.getAttribute("cf-label")) this._label = this.domElement.getAttribute("cf-label");
                ...
                var t = this.domElement.parentNode;
                if (t) {
                    var e = "label" == t.tagName.toLowerCase() ? [t] : t.getElementsByTagName("label");
                    if (0 == e.length) {
...
! function(t) {
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "required", {
            ...
            get: function() {
                if (this.questions && this.questions.length > 0) return this.questions[Math.floor(Math.random() * this.questions.length)];
    ...
    var e = function(e) {
        ...
        return __extends(n, e), Object.defineProperty(n.prototype, "type", {
            ...
            if (!e && 1 == n.length) {
                ...
                u.selected = !0, o.selected = !0, e = !0, o.selected && this._values.push(o.value)
            }
            return e
        }, n
    }(t.Tag);
...
! function(t) {
    var e = function(t) {
        ...
        return __extends(e, t), e.prototype.dealloc = function() {
            t.prototype.dealloc.call(this)
        }, e
    }(t.Tag);
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(n, e), Object.defineProperty(n.prototype, "value", {
            ...
            this._files = this.referenceTag.domElement.files, i.onerror = function(e) {
                t.ConversationalForm.suppressLog || console.log("onerror", e)
            }, i.onprogress = function(e) {
                t.ConversationalForm.suppressLog || console.log("onprogress", e), n.progressBar.style.width = e.loaded / e.total * 100 + "%"
                ...
                n._readerResult = e.target.result, n.progressBar.classList.add("loaded"), n.submitTimer = setTimeout(function() {
                    n.el.classList.remove("animate-in"), n.onChoose(),
    ...
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "hasUserMedia", {
            ...
            void 0 === e && (e = 0), this.button.loading = !0, this.equalizer && (this.equalizer.disabled = !1), this.promise = new Promise(function(t, e) {
                ...
                if (n.promise = null, n.currentTextResponse = e.toString(), !n.currentTextResponse || "" == n.currentTextResponse) return n.showError(t.Dictionary.get("user-audio-reponse-invalid")), void n.callInput();
                n.inputErrorCount = 0, n.inputCurrentError = "", n.button.loading = !1;
                var i = {
                    text: n.currentTextResponse
                };
                t.ConversationalForm.illustrateFlow(n, "dispatch", t.UserInputEvents.SUBMIT, i), n.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.SUBMIT, {
                    detail: i
                }))
            }).catch(function(e) {
                n.isErrorTerminal(e) ? (n.eventTarget.dispatchEvent(new CustomEvent(t.MicrophoneBridgeEvent.TERMNIAL_ERROR, {
                    detail: t.Dictionary.get("microphone-terminal-error")
                })), t.ConversationalForm.suppressLog || console.log("Conversational Form: Terminal error: ", e)) : (n.inputCurrentError != e && (n.inputErrorCount = 0, n.inputCurrentError = e), n.inputErrorCount++, n.inputErrorCount > 2 ? n.showError(e) : (n.eventTarget.dispatchEvent(new CustomEvent(t.MicrophoneBridgeEvent.TERMNIAL_ERROR, {
                    detail: t.Dictionary.get("microphone-terminal-error")
            ...
            t.ConversationalForm.illustrateFlow(this, "dispatch", t.FlowEvents.USER_INPUT_INVALID, n), this.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_INVALID, {
                detail: n
            })), this.callInput()
        }, e.prototype.setupEqualizer = function() {
            var t = this.el.getElementsByTagName("cf-icon-audio-eq")[0];
            n.supported && t && (this.equalizer = new n({
...
! function(t) {
    ...
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "typing", {
            ...
            this.mic && (this.mic.dealloc(), this.mic = null, this.el.removeChild(this.el.getElementsByClassName("cf-microphone")[0]), this.el.classList.remove("microphone-interface"), this.loading = !1, this.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_INVALID, {
                detail: {
                    errorText: e.detail
                }
            })))
        }, e.prototype.onClick = function(e) {
            this.mic && !this.typing ? this.mic.callInput() : this.eventTarget.dispatchEvent(new CustomEvent(t.UserInputSubmitButtonEvents.CHANGE))
...
! function(t) {
    var e = function(e) {
        ...
        return __extends(n, e), Object.defineProperty(n.prototype, "currentTag", {
            get: function() {
    ...
    var e = function(e) {
        function n(n) {
            ...
            return i.errorTimer = 0, i.initialInputHeight = 0, i.shiftIsDown = !1, i._active = !1, i.cfReference = n.cfReference, i.eventTarget = n.eventTarget, i.inputElement = i.el.getElementsByTagName("textarea")[0], i.onInputFocusCallback = i.onInputFocus.bind(i), i.onInputBlurCallback = i.onInputBlur.bind(i), i.inputElement.addEventListener("focus", i.onInputFocusCallback, !1), i.inputElement.addEventListener("blur", i.onInputBlurCallback, !1), i.controlElements = new t.ControlElements({
                ...
                eventTarget: i.eventTarget
            }), i.el.appendChild(i.submitButton.el), n.microphoneInputObj && (i.microphoneObj = n.microphoneInputObj, i.microphoneObj && i.microphoneObj.init && i.microphoneObj.init(), i.submitButton.addMicrophone(i.microphoneObj)), i
        }
        return __extends(n, e), Object.defineProperty(n.prototype, "active", {
            ...
            }, t.tag || (t.tag = this.currentTag), t.input = this, t.tag = this.currentTag, t
            ...
            var t = this.inputElement.getAttribute("type"),
                ...
                i = "email" == this._currentTag.type && "email" != t || "number" == this._currentTag.type && "number" != t;
            if (this.inputElement && (e || n) && (this.inputElement.removeEventListener("focus", this.onInputFocusCallback, !1), this.inputElement.removeEventListener("blur", this.onInputBlurCallback, !1)), e || i) {
                var o = document.createElement("input");
                Array.prototype.slice.call(this.inputElement.attributes).forEach(function(t) {
                    o.setAttribute(t.name, t.value)
                }), o.setAttribute("autocomplete", "new-password"), this.inputElement.parentNode.replaceChild(o, this.inputElement), this.inputElement = o, "number" !== this._currentTag.type && "email" !== this._currentTag.type || (this.inputElement.type = this._currentTag.type, o.setAttribute("type", this._currentTag.type))
            } else if (n) {
                var s = document.createElement("textarea");
                Array.prototype.slice.call(this.inputElement.attributes).forEach(function(t) {
                    s.setAttribute(t.name, t.value)
                }), this.inputElement.parentNode.replaceChild(s, this.inputElement), this.inputElement = s
            }
            ...
            var o = -1 !== ["password", "number", "email"].indexOf(this._currentTag.type);
            ...
            (this.active || this.controlElements.focus) && (this.isControlElementsActiveAndUserInputHidden() || this.isMetaKeyPressed(e) || (e.keyCode == t.Dictionary.keyCodes.shift && (this.shiftIsDown = !0), e.keyCode != t.Dictionary.keyCodes.enter || e.shiftKey || e.preventDefault()))
            ...
            this.submitButton.typing = e.text && e.text.length > 0, t.ConversationalForm.illustrateFlow(this, "dispatch", t.UserInputEvents.KEY_CHANGE, e), this.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.KEY_CHANGE, {
                detail: {
                    dto: e,
                    keyCode: n,
            ...
            this.submitButton.loading = !0, this.disabled = !0, this.el.removeAttribute("error"), this.inputElement.setAttribute("data-value", ""), t.ConversationalForm.illustrateFlow(this, "dispatch", t.UserInputEvents.SUBMIT, e), this.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.SUBMIT, {
                detail: e
            }))
...
! function(t) {
    ...
    var e = function(e) {
        function n(t) {
            var n = e.call(this, t) || this;
            return n.readyTimer = 0, n.container = t.container, n.uiOptions = t.cfReference.uiOptions, n._tag = t.tag, n
        }
        return __extends(n, e), Object.defineProperty(n.prototype, "tag", {
            ...
            set: function(t) {
                var e = this;
                this.el.offsetWidth, setTimeout(function() {
                    return t ? e.el.classList.add("show") : e.el.classList.remove("show")
                }, 100)
            },
            enumerable: !0,
            configurable: !0
            ...
            if (this.originalResponse) {
                ...
                if (-1 != e.indexOf("contains-image") && this.textEl.classList.add("contains-image"), this.isRobotResponse) {
                    ...
                    for (var c = e.split("&&"), u = this, h = 0; h < c.length; h++) ! function(e) {
                        var n = c[e];
                        setTimeout(function() {
                            t.tryClearThinking(), t.textEl.innerHTML += "<p>" + n + "</p>";
                            var e = t.textEl.getElementsByTagName("p");
                            e[e.length - 1].offsetWidth, e[e.length - 1].classList.add("show"), t.scrollTo()
                    ...
                    this.tryClearThinking(), this.textEl.innerHTML = "<p>" + e + "</p>";
                    var p = this.textEl.getElementsByTagName("p");
                    p[p.length - 1].offsetWidth, p[p.length - 1].classList.add("show"), this.scrollTo()
                }
                this.parsedResponse = e, this.addSelf(), this.textEl.removeAttribute("value-added"), setTimeout(function() {
            ...
            !this.container && this.el && (this.container = this.el), this.container.scrollTop = t + e + this.container.scrollTop
            ...
            this.el.parentNode != this.container && this.container.appendChild(this.el)
        }, n.prototype.onClick = function(e) {
        ...
        }, n.THINKING_MARKUP = "<p class='show'><thinking><span>.</span><span>.</span><span>.</span></thinking></p>", n
    }(t.BasicElement);
    t.ChatResponse = e
}(cf || (cf = {}));
var __extends = this && this.__extends || function() {
    ...
    var e = function() {
        ...
        return Object.defineProperty(e.prototype, "currentTag", {
            ...
            var o = this.currentTag.setTagValueAndIsValid(i),
                ...
                a = function() {
                    return n.currentTag.validationCallback && "function" == typeof n.currentTag.validationCallback && !s && o ? (s = !0, void n.currentTag.validationCallback(i, function() {
                        ...
                        o = !1, t && (i.errorText = t), a()
                    })) : void(o ? (t.ConversationalForm.illustrateFlow(n, "dispatch", t.FlowEvents.USER_INPUT_UPDATE, i), i.input && (i = i.input.getFlowDTO()), n.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_UPDATE, {
                        detail: i
                    })), setTimeout(function() {
                        return n.nextStep()
                ...
                if (s !== e)
                    for (var r = 0; r < n.length; r++) {
                        ...
                        if ("" !== l && "cf-conditional-" + l === a.key.toLowerCase()) {
                            ...
                            if (u && (this.activeConditions[l] = n, ++i == n.length)) return !0
                        }
                    }
            }
            return !1
            ...
            if (this.ignoreExistingTags = !1, this.savedStep = this.step - 1, this.step = this.tags.indexOf(t), this.validateStepAndUpdate(), this.activeConditions && Object.keys(this.activeConditions).length > 0) {
                ...
                for (var e = this.tags.indexOf(t), n = e + 1; n < this.tags.length; n++) {
                    this.tags[n].reset()
                }
            }
            ...
            this.stopped || (t.ConversationalForm.illustrateFlow(this, "dispatch", t.FlowEvents.FLOW_UPDATE, this.currentTag), this.currentTag.refresh(), setTimeout(function() {
                e.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.FLOW_UPDATE, {
                    detail: {
                        tag: e.currentTag,
...
! function(cf_1) {
    var ConversationalForm = function() {
        ...
        return Object.defineProperty(ConversationalForm.prototype, "createId", {
            ...
            if (this.loadExternalStyleSheet) {
                ...
                e.type = "text/css", e.media = "all", e.setAttribute("rel", "stylesheet"), e.setAttribute("href", n), t.appendChild(e)
            ...
            if (-1 == ["fixed", "absolute", "relative"].indexOf(window.getComputedStyle(this.context).getPropertyValue("position").toLowerCase()) && (this.context.style.position = "relative"), !this.tags || 0 == this.tags.length) {
                this.tags = [];
                for (var i = [].slice.call(this.formEl.querySelectorAll("input, select, button, textarea, cf-robot-message"), 0), o = 0; o < i.length; o++) {
                    var s = i[o];
            ...
            this.userInput.disabled = !1, ConversationalForm.suppressLog || console.log("option, disabled 3"), this.userInput.visible = !0, this.flowManager.start()
            ...
            if (Object.keys(e).length > 0)
                for (var o in e)
                    if (e[o].length > 0) {
                        ...
                        s && "fieldset" !== s.tagName.toLowerCase() && (s = s.parentNode, function(t) {
                            return t && "fieldset" !== t.tagName.toLowerCase() && !t.hasAttribute("cf-questions")
                        }(s) && (s = null));
                        for (var r = new cf_1.TagGroup({
                                fieldset: s,
                                elements: e[o]
                            }), n = 0; n < e[o].length; n++) {
                            var a = e[o][n];
                            0 == n ? t.splice(t.indexOf(a), 1, r) : t.splice(t.indexOf(a), 1)
                        }
                    }
            return t
            ...
            t.className = "conversational-form-inner", this.el.appendChild(t), this.chatList = new cf_1.ChatList({
                eventTarget: this.eventTarget,
                cfReference: this
            }), t.appendChild(this.chatList.el), this.userInput = new cf_1.UserTextInput({
            ...
            for (var i = [], o = 0; o < t.length; o++) {
                ...
                if ("fieldset" === s.tag)
                    for (var r = cf_1.TagsParser.parseGroupTag(s), a = 0; a < r.children.length; a++) {
                        ...
                        var l = "select" === s.tag ? cf_1.TagsParser.parseGroupTag(s) : cf_1.TagsParser.parseTag(s);
                        if (cf_1.Tag.isTagValid(l)) {
                            var c = cf_1.Tag.createTag(l);
                            i.push(c)
                        }
            ...
            if (void 0 === i && (i = null), ConversationalForm.illustrateAppFlow) {
                ...
                ConversationalForm.suppressLog || console.log("%c** event flow: %c" + n + "%c flow type: %c" + e + "%c from: %c" + t.constructor.name, "font-weight: 900;", o, "font-weight: 400;", o, "font-weight: 400;", o), i && (ConversationalForm.suppressLog || console.log("** event flow detail:", i))
            }
        ...
        }, ConversationalForm.animationsEnabled = !0, ConversationalForm.illustrateAppFlow = !0, ConversationalForm.suppressLog = !0, ConversationalForm.hasAutoInstantiated = !1, ConversationalForm
    }();
    ...
    function(t, e) {
        "function" == typeof define && define.amd ? define(["conversational-form"], function(n) {
            return t.conversationalform = e(n)
        }) : "object" == typeof module && module.exports ? module.exports = t.conversationalform = e(require("conversational-form")) : t.conversationalform = e(cf.ConversationalForm)
    }(window, function(t) {
